...
class Car {
    ...
    changes;
    works;
    constructor(brand, name, year, age, max_speed, color, changes, works) {
        this.brand = brand;
        this.name = name;
        this.year = year;
        this.age = age;
...
class Mercedes extends Car {
    constructor(name, year, age, max_speed, color, changes, works) {
...
const c_class = new Mercedes("C-Class", 2020, 5, 200, "black", {
    is_crashed: false,
    is_repaired: true,
    is_painted: false
}, [
...
const e_class = new Mercedes("E-Class", 2022, 3, 240, "red", {
    is_crashed: true,
    is_repaired: true,
    is_painted: true
}, [
...
const a4 = new Audi("A4", 2021, 4, 220, "white", {
    is_crashed: true,
    is_repaired: false,
    is_painted: false
}, []);
console.log(a4.show());
const rs7 = new Audi("RS7", 2021, 4, 220, "white", {
    is_crashed: true,
    is_repaired: false,
    is_painted: true
}, [
...
const m3_touring = new BMW("M3 Touring", 2022, 3, 250, "red", {
    is_crashed: false,
    is_repaired: true,
    is_painted: false
}, [
...
const x5 = new BMW("X5", 2022, 3, 250, "red", {
    is_crashed: false,
    is_repaired: true,
    is_painted: false
}, [
